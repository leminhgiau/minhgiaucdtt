        ...
        <div className="navbar-header" data-logobg="skin6">
          ...
          <a className="navbar-brand" href="dashboard.html">
            ...
            <span className="logo-text">
              {/* dark Logo text */}
              <img src={require("../../../assets/images/banners/logo-text.png")} alt="homepage" />
            </span>
          </a>
          {/* ============================================================== */}
          {/* End Logo */}
                  ...
                  <li>
                    ...
                    >
                      ...
                      <div className="ms-2">
                        <span className="text-dark">
                          Genelia Deshmukh{" "}
                          <small className="d-block text-warning">Away</small>
                        </span>
                      </div>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <div className="ms-2">
                        <span className="text-dark">
                          Ritesh Deshmukh{" "}
                          <small className="d-block text-danger">Busy</small>
                        </span>
                      </div>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <div className="ms-2">
                        <span className="text-dark">
                          Arijit Sinh{" "}
                          <small className="d-block text-muted">Offline</small>
                        </span>
                      </div>
                    </a>
                  </li>
