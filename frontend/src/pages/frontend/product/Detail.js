        ...
        <div className="row">
              ...
              <article className="gallery-wrap">
                <div className="img-big-wrap">
                  <div>
                    {" "}
                    <a href="#">
                      <img src={require("../../../assets/images/items/fashion1.jpg")} />
                    </a>
                  </div>
                </div>{" "}
                {/* slider-product.// */}
                <div className="thumbs-wrap">
                  <a href="#" className="item-thumb">
                    {" "}
                    <img src={require("../../../assets/images/items/fashion2.jpg")} />
                  </a>
                  <a href="#" className="item-thumb">
                    {" "}
                    <img src={require("../../../assets/images/items/fashion3.jpg")} />
                  </a>
                  <a href="#" className="item-thumb">
                    {" "}
          ...
          <main className="col-md-6">
            <article className="product-info-aside">
              <h2 className="title mt-3">Fasjion Chanel </h2>
