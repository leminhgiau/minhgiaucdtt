...
/* MENU */Route::get('menu/menu_list/{position}/{parent_id?}/{status?}',[MenuController::class,'menu_list']);
...
Route::post('page/store', [PageController::class, 'store']);Route::post('page/update/{id}', [PageController::class, 'update']);
